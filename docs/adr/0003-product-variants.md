...
- **No variants, six Products** (the current state) — rejected because the "shopping for a t-shirt" experience breaks the moment a customer sees the second colour.
